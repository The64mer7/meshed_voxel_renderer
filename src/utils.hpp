...
#define MAKE_COLOR_OFFSET(r, g, b, a, offset)                                                      \
    (((uint32_t)((r) + (offset)) & 0xFFu) | (((uint32_t)((g) + (offset)) & 0xFFu) << 8) |          \
     (((uint32_t)((b) + (offset)) & 0xFFu) << 16) | (((uint32_t)(a) & 0xFFu) << 24))
...
inline float hash(float n) { return glm::fract(191122.518925 + glm::sin(n) * 43758.5453123); }
